...
This solution uses natural language processing techniques to preprocess incident comments and verifies suspected tokens by comparing them with deal and portfolio IDs in the deals database. This allows for the precise and robust identification of deals impacted by incidents.

You can further refine and adapt this solution based on the specific structure of your data and incident comments. For more complex comments, using advanced NLP models like BERT could improve the accuracy of information extraction.